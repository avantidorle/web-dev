...
const profile = useSelector((state) => state.profile[0]);
  return (
    ...
    <div>
        ...
        <p>{profile.bio}</p>
        <div>
            <div className="wd-profile-details"><i class="fa fa-map-marker me-2" aria-hidden="true"></i>{profile.location}</div>
            <div className="wd-profile-details"><i class="fa-solid fa-baby me-2 ms-4"></i>
            Born {profile.dateOfBirth}
            </div>
            <div className="wd-profile-details">
            <i class="fa fa-calendar me-2 ms-4" aria-hidden="true">
